  ...
  if (state === "loading") {
    return (
      <section className="mb-8">
        <div className="bg-[#F9F7ED] border border-[#E6D7A2] rounded-2xl p-5 flex items-center gap-3">
          <svg
            className="w-4 h-4 text-[#92722A] animate-spin flex-shrink-0"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
            strokeWidth={2}
          ...
          <span className="text-sm text-[#7C5E24] font-medium">
    ...
    <section className="mb-8">
      <div className="bg-[#F9F7ED] border border-[#E6D7A2] rounded-2xl p-5">
        ...
        <div className="flex items-center gap-2 mb-3">
          ...
          <span className="text-xs font-semibold uppercase tracking-widest text-[#92722A]">
            Leadership Readout · AI Synthesis
          </span>
        </div>
        <div className="text-sm font-semibold text-[#5D3B26] mb-3">
        ...
        <ol className="space-y-2.5">
          {observations.map((obs, i) => (
            <li key={i} className="flex items-start gap-2.5">
              <span className="text-[#92722A] font-bold text-xs mt-0.5 flex-shrink-0">
                {i + 1}.
              </span>
